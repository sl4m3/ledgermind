    ...
    if provider == "openrouter" and mode == "rich":
        ...
        while True:
            ...
            try:
                ...
                with global_console.status(f"Validating model [bold cyan]{escape(enrichment_model)}[/bold cyan] via OpenRouter API...", spinner="dots"):
                    response = httpx.post(
    ...
    if mode == "rich" and provider == "cli" and client in ["gemini", "claude"]:
        ...
        while True:
            ...
            try:
                ...
                with global_console.status(f"Validating model [bold cyan]{escape(enrichment_model)}[/bold cyan] via {client}...", spinner="dots"):
    ...
    if provider == "aistudio":
        ...
        while True:
            ...
            try:
                ...
                with global_console.status(f"Validating model [bold cyan]{escape(aistudio_model)}[/bold cyan] via Google AI Studio...", spinner="dots"):
