...
class IntegrationBridge:
    ...
    def __init__(self, memory_path: str = ".ledgermind", relevance_threshold: float = 0.5, retention_turns: int = 10, vector_model: Optional[str] = None, default_cli: Optional[List[str]] = None, memory_instance: Optional[Memory] = None):
