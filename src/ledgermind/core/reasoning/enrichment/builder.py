...
class PromptBuilder:
    ...
    def build_system_prompt(target: str, rationale: str, config: EnrichmentConfig) -> str:
        ...
        return (
            ...
            "2. target: A concise, semantically meaningful hierarchical path that describes the knowledge domain (e.g., 'core/pipeline/event_processing', 'reasoning/enrichment/llm_integration'). This should capture the ESSENCE of what the knowledge is about, not just file paths.\n"
            "3. rationale: Full, detailed architectural rationale focusing on 'what' and 'why'. Use Markdown.\n"
            "4. compressive: Exactly 3 sentences summarizing the technical essence.\n"
            "5. strengths: List of technical advantages.\n"
            "6. objections: List of potential risks or drawbacks.\n"
            "7. consequences: List of architectural impacts.\n"
            "8. estimated_utility: Number (0.0-1.0) representing current usefulness.\n"
            "9. estimated_removal_cost: Number (0.0-1.0) representing the risk of losing this knowledge.\n"
            f"10. keywords: A flat list of 4-6 items. For every semantic concept, you MUST include two separate strings: one in {lang} and one in English (e.g., ['Слоистая архитектура', 'Layered Architecture', 'Инъекция зависимостей', 'Dependency Injection']).\n"
            "11. procedural: List of {action, expected_outcome, rationale} steps representing the workflow."
        )
