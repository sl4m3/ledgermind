...
def bridge(temp_memory_path):
    ...
    return IntegrationBridge(memory_path=temp_memory_path, relevance_threshold=0.7, vector_model="v5-small-text-matching-Q4_K_M.gguf")
...
def test_negative_filtering(bridge, temp_memory_path):
    ...
    strict_bridge = IntegrationBridge(memory_path=temp_memory_path, relevance_threshold=0.99, vector_model="v5-small-text-matching-Q4_K_M.gguf")
...
def test_threshold_behavior(bridge, temp_memory_path):
    ...
    high_bridge = IntegrationBridge(memory_path=temp_memory_path, relevance_threshold=1.0, vector_model="v5-small-text-matching-Q4_K_M.gguf")
