    ...
    "Benchmark": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "392ef0d8af09ecc8f12ab68b689f824d4b56a3d9",
          "message": "🎨 Palette: Improve JSON parse error visibility in CLI (#150)",
          "timestamp": "2026-04-24T16:39:50+03:00",
          "tree_id": "dcb5ba402cbc5a56f4e3b5201a183de8e06e22ca",
          "url": "https://github.com/sl4m3/ledgermind/commit/392ef0d8af09ecc8f12ab68b689f824d4b56a3d9"
        },
        "date": 1777038221599,
        "tool": "pytest",
        "benches": [
          {
            "name": "tests/core/performance/bench_ops.py::test_benchmark_record_decision",
            "value": 106.90933203424424,
            "unit": "iter/sec",
            "range": "stddev: 0.00011260775715209868",
            "extra": "mean: 9.35372040000857 msec\nrounds: 5"
          },
          {
            "name": "tests/core/performance/bench_ops.py::test_benchmark_search_fast_path",
            "value": 13117.403383976995,
            "unit": "iter/sec",
            "range": "stddev: 0.000007839986079922117",
            "extra": "mean: 76.23459999877014 usec\nrounds: 5"
          },
          {
            "name": "tests/core/performance/bench_ops.py::test_benchmark_search_hybrid_rrf",
            "value": 1320.8078483195518,
            "unit": "iter/sec",
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "e8903c518b1150e10c1e863a8167e3f7ec35b660",
          "message": "Optimize tight query loops inline functions (#156)",
          "timestamp": "2026-05-01T14:49:47+03:00",
          "tree_id": "a5966b2c58ee5649962b4d3279625da4b217cd03",
          "url": "https://github.com/sl4m3/ledgermind/commit/e8903c518b1150e10c1e863a8167e3f7ec35b660"
        },
        "date": 1777636411117,
        "tool": "pytest",
        "benches": [
          {
            "name": "tests/core/performance/bench_ops.py::test_benchmark_record_decision",
            "value": 96.5163038524121,
            "unit": "iter/sec",
            "range": "stddev: 0.00015537266373630783",
            "extra": "mean: 10.360943800014866 msec\nrounds: 5"
          },
          {
            "name": "tests/core/performance/bench_ops.py::test_benchmark_search_fast_path",
            "value": 10540.651074825588,
            "unit": "iter/sec",
            "range": "stddev: 0.000025475515345027254",
            "extra": "mean: 94.87080000099013 usec\nrounds: 5"
          },
          {
            "name": "tests/core/performance/bench_ops.py::test_benchmark_search_hybrid_rrf",
            "value": 1207.385626191073,
            "unit": "iter/sec",
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "fe1f5e534610fdfd6a7310629c9709b1ccbd2b6c",
          "message": "Update questionary.text to questionary.path for directory inputs (#166)",
          "timestamp": "2026-05-07T14:11:03+03:00",
          "tree_id": "16d90544358e7f47c0a6f1b7268b0e23fad2ff80",
          "url": "https://github.com/sl4m3/ledgermind/commit/fe1f5e534610fdfd6a7310629c9709b1ccbd2b6c"
        },
        "date": 1778152497112,
        "tool": "pytest",
        "benches": [
          {
            "name": "tests/core/performance/bench_ops.py::test_benchmark_record_decision",
            "value": 96.68047586130763,
            "unit": "iter/sec",
            "range": "stddev: 0.00024929368165279713",
            "extra": "mean: 10.343349999999418 msec\nrounds: 5"
          },
          {
            "name": "tests/core/performance/bench_ops.py::test_benchmark_search_fast_path",
            "value": 10855.42956137129,
            "unit": "iter/sec",
            "range": "stddev: 0.00001984920899323725",
            "extra": "mean: 92.1197999900869 usec\nrounds: 5"
          },
          {
            "name": "tests/core/performance/bench_ops.py::test_benchmark_search_hybrid_rrf",
            "value": 1243.5926994937695,
            "unit": "iter/sec",
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "44e0f5314659d207b8af0169156a33d5a633aaf2",
          "message": "🎨 Palette: [Obscure API key input in CLI] (#171)",
          "timestamp": "2026-05-10T06:28:03-05:00",
          "tree_id": "206cab579698d52056d09171140448242c4d5deb",
          "url": "https://github.com/sl4m3/ledgermind/commit/44e0f5314659d207b8af0169156a33d5a633aaf2"
        },
        "date": 1778412717923,
        "tool": "pytest",
        "benches": [
          {
            "name": "tests/core/performance/bench_ops.py::test_benchmark_record_decision",
            "value": 90.88959426483629,
            "unit": "iter/sec",
            "range": "stddev: 0.00015009661672898996",
            "extra": "mean: 11.00235960000191 msec\nrounds: 5"
          },
          {
            "name": "tests/core/performance/bench_ops.py::test_benchmark_search_fast_path",
            "value": 10062.953839518696,
            "unit": "iter/sec",
            "range": "stddev: 0.000014168782427192222",
            "extra": "mean: 99.37439999703201 usec\nrounds: 5"
          },
          {
            "name": "tests/core/performance/bench_ops.py::test_benchmark_search_hybrid_rrf",
            "value": 1174.3454374547844,
            "unit": "iter/sec",
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "bd5eeccf52ec415f0c61e10728c58e4a6828e71d",
          "message": "fix: update update_knowledge_item and delete_knowledge_item methods",
          "timestamp": "2026-07-15T09:06:18-05:00",
          "tree_id": "ce48afdc1118797ce4cb62a510bcac7f190b00cf",
          "url": "https://github.com/sl4m3/ledgermind/commit/bd5eeccf52ec415f0c61e10728c58e4a6828e71d"
        },
        "date": 1784124628074,
        "tool": "pytest",
        "benches": [
          {
            "name": "tests/core/performance/bench_ops.py::test_benchmark_record_decision",
            "value": 91.19595358447727,
            "unit": "iter/sec",
            "range": "stddev: 0.0001343664888601589",
            "extra": "mean: 10.965398799999093 msec\nrounds: 5"
          },
          {
            "name": "tests/core/performance/bench_ops.py::test_benchmark_search_fast_path",
            "value": 11609.385956703287,
            "unit": "iter/sec",
            "range": "stddev: 0.000020695064265037886",
            "extra": "mean: 86.13719999743807 usec\nrounds: 5"
          },
          {
            "name": "tests/core/performance/bench_ops.py::test_benchmark_search_hybrid_rrf",
            "value": 2993.7556244958687,
            "unit": "iter/sec",
            "range": "stddev: 0.00003937731064808421",
            "extra": "mean: 334.02860000251167 usec\nrounds: 5"
          }
        ]
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "ac5f29ea6b5a0ee559c987e25f72ae2190877445",
          "message": "refactor: remove mode and import_limit from installers (new spec)",
          "timestamp": "2026-07-15T09:20:13-05:00",
          "tree_id": "9e3aaf938ff231315d7e76f532cdf99ade206dba",
          "url": "https://github.com/sl4m3/ledgermind/commit/ac5f29ea6b5a0ee559c987e25f72ae2190877445"
        },
        "date": 1784125475710,
        "tool": "pytest",
        "benches": [
          {
            "name": "tests/core/performance/bench_ops.py::test_benchmark_record_decision",
            "value": 93.1791032815784,
            "unit": "iter/sec",
            "range": "stddev: 0.00022662203878360794",
            "extra": "mean: 10.732020000000375 msec\nrounds: 5"
          },
          {
            "name": "tests/core/performance/bench_ops.py::test_benchmark_search_fast_path",
            "value": 11190.313663688716,
            "unit": "iter/sec",
            "range": "stddev: 0.000009412562742867003",
            "extra": "mean: 89.36300000641495 usec\nrounds: 5"
          },
          {
            "name": "tests/core/performance/bench_ops.py::test_benchmark_search_hybrid_rrf",
            "value": 2633.777458393579,
            "unit": "iter/sec",
            "range": "stddev: 0.00002612166249424561",
            "extra": "mean: 379.6828000076857 usec\nrounds: 5"
          }
        ]
      }
    ]
