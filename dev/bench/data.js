    ...
    "Benchmark": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "a38c911bbf6e4d51f60f35c02325b0dc3e516132",
          "message": "docs: update performance metrics in README to reflect v3.0.3 benchmarks",
          "timestamp": "2026-02-28T15:15:20+03:00",
          "tree_id": "cc6fa9658d64a9af8d4696b67ba900b8dcd0572f",
          "url": "https://github.com/sl4m3/ledgermind/commit/a38c911bbf6e4d51f60f35c02325b0dc3e516132"
        },
        "date": 1772281153037,
        "tool": "pytest",
        "benches": [
          {
            "name": "tests/core/performance/test_bench_ops.py::test_benchmark_record_decision",
            "value": 42.64102801516498,
            "unit": "iter/sec",
            "range": "stddev: 0.0009676837485943132",
            "extra": "mean: 23.451592199990046 msec\nrounds: 5"
          },
          {
            "name": "tests/core/performance/test_bench_ops.py::test_benchmark_search_decisions",
            "value": 17970.585676964598,
            "unit": "iter/sec",
            "range": "stddev: 0.000005584120923204484",
            "extra": "mean: 55.64648910034354 usec\nrounds: 3441"
          }
        ]
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "b882d97c1c97bad62c9a2e3904335f8f1d802a5a",
          "message": "docs: finalize performance table in README (v3.0.3 OPS data)",
          "timestamp": "2026-02-28T15:17:48+03:00",
          "tree_id": "c98e41345da1d9e983269dda068cf4c194d5aedd",
          "url": "https://github.com/sl4m3/ledgermind/commit/b882d97c1c97bad62c9a2e3904335f8f1d802a5a"
        },
        "date": 1772281310358,
        "tool": "pytest",
        "benches": [
          {
            "name": "tests/core/performance/test_bench_ops.py::test_benchmark_record_decision",
            "value": 43.31089214108241,
            "unit": "iter/sec",
            "range": "stddev: 0.0014704670591385793",
            "extra": "mean: 23.08888019998676 msec\nrounds: 5"
          },
          {
            "name": "tests/core/performance/test_bench_ops.py::test_benchmark_search_decisions",
            "value": 17584.941829378637,
            "unit": "iter/sec",
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "166e603ca26a9be37addb2b0f121d0f0bba6507b",
          "message": "docs: use more realistic performance metrics based on v3.0.3 averages",
          "timestamp": "2026-02-28T15:25:36+03:00",
          "tree_id": "9028ee4e5572cc366a57db3a74e1dc15fd122882",
          "url": "https://github.com/sl4m3/ledgermind/commit/166e603ca26a9be37addb2b0f121d0f0bba6507b"
        },
        "date": 1772281809292,
        "tool": "pytest",
        "benches": [
          {
            "name": "tests/core/performance/test_bench_ops.py::test_benchmark_record_decision",
            "value": 41.25252602620915,
            "unit": "iter/sec",
            "range": "stddev: 0.0014618040850751589",
            "extra": "mean: 24.240939800017713 msec\nrounds: 5"
          },
          {
            "name": "tests/core/performance/test_bench_ops.py::test_benchmark_search_decisions",
            "value": 17622.44867257141,
            "unit": "iter/sec",
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "1fe3aa649a0065c3bf10066dc8834f1c0e7a7044",
          "message": "perf: finalize search and record optimizations, update benchmark seeding logic",
          "timestamp": "2026-02-28T22:22:37+03:00",
          "tree_id": "8e970fbf1dfb057728e107ee97032e6e99589f2e",
          "url": "https://github.com/sl4m3/ledgermind/commit/1fe3aa649a0065c3bf10066dc8834f1c0e7a7044"
        },
        "date": 1772306732355,
        "tool": "pytest",
        "benches": [
          {
            "name": "tests/core/performance/test_bench_ops.py::test_benchmark_record_decision",
            "value": 70.2485730301103,
            "unit": "iter/sec",
            "range": "stddev: 0.000238732442322113",
            "extra": "mean: 14.235164600017924 msec\nrounds: 5"
          },
          {
            "name": "tests/core/performance/test_bench_ops.py::test_benchmark_search_decisions",
            "value": 663.447530794932,
            "unit": "iter/sec",
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "f3f0377be6c4a3ec35cc24f020a2241346540e01",
          "message": "perf: enable git in benchmarks for honest full-stack evaluation",
          "timestamp": "2026-02-28T22:51:45+03:00",
          "tree_id": "f6a92679af49c443eef652731cfc312587d82251",
          "url": "https://github.com/sl4m3/ledgermind/commit/f3f0377be6c4a3ec35cc24f020a2241346540e01"
        },
        "date": 1772308470308,
        "tool": "pytest",
        "benches": [
          {
            "name": "tests/core/performance/test_bench_ops.py::test_benchmark_record_decision",
            "value": 70.68326486907308,
            "unit": "iter/sec",
            "range": "stddev: 0.00019690023295625912",
            "extra": "mean: 14.14762039999573 msec\nrounds: 5"
          },
          {
            "name": "tests/core/performance/test_bench_ops.py::test_benchmark_search_decisions",
            "value": 19602.769477546473,
            "unit": "iter/sec",
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "0c25fd970ff75cf33b39a9a9abff5708580f01fb",
          "message": "fix(core): resolve CI failures while maintaining 18k+ search speed\n\n- Enforced raw tuple output in keyword_search for zero-copy performance.\n- Fixed KeyError: 0 by synchronizing memory search logic with tuple indices.\n- Restored lightweight (7-field) fast-path for short search queries.\n- Added link_count synchronization in link_evidence for O(1) grounding data.\n- Adapted ranking/RRF tests to use longer queries, forcing hybrid path verification.\n- Verified 11k+ iter/sec in Termux (target 17k+ on GitHub Actions).",
          "timestamp": "2026-03-01T01:42:33+03:00",
          "tree_id": "c3b610aa16f0236f03bdf4c45cfddec48a56f580",
          "url": "https://github.com/sl4m3/ledgermind/commit/0c25fd970ff75cf33b39a9a9abff5708580f01fb"
        },
        "date": 1772318689599,
        "tool": "pytest",
        "benches": [
          {
            "name": "tests/core/performance/test_bench_ops.py::test_benchmark_record_decision",
            "value": 68.71154704279319,
            "unit": "iter/sec",
            "range": "stddev: 0.0001312356380276617",
            "extra": "mean: 14.553594600005226 msec\nrounds: 5"
          },
          {
            "name": "tests/core/performance/test_bench_ops.py::test_benchmark_search_decisions",
            "value": 17827.09147346651,
            "unit": "iter/sec",
