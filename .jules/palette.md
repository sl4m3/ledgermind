...
## 2026-05-19 - Adding visual feedback to blocking CLI operations
**Learning:** Users lack visibility during long-running background tasks (like API validation requests), making the application appear frozen and unresponsive.
**Action:** Always wrap blocking operations (network requests or subprocesses) in a `with global_console.status('...', spinner='dots'):` context manager to provide immediate visual feedback.
