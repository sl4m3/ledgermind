...
1.  **[Core](./core)** (`agent-memory-core` v1.18.0): The domain heart. Handles storage (Hybrid Semantic Store: SQLite + Git, Episodic, Vector), Epistemic Reasoning (Reflection v5, Distillation), and Transactional Integrity.
