...
2.  **[MCP Server](./mcp_server)** (`agent-memory-server` v1.9.0): The enforcement layer and transport. Implements RBAC, Isolation Rules, and a **formal industrial-grade API specification**.
